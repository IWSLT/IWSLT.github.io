...
* As a *dev* set, we release a minimal example taken from the EuroParl Interviews (EPI) en-es test set by [Papi et al., 2023](https://doi.org/10.1162/tacl_a_00607).  
  * [__The dev set can be downloaded here!__](https://drive.google.com/file/d/169yBHOHU5UcFEu5GNgBXL7L_mlvnmyIp) It contains a non-compliant example with its scores (block by block and overall) and the corresponding compliant version with its score.
