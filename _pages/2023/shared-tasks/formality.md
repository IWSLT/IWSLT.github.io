...
Table: Supervised (F: Formal; IF: Informal); First four columns (En-Ko) and Next four columns (En-Vi) 
...
Table: Zero-shot (F: Formal; IF: Informal); First four columns (En-Pt) and Next four columns (En-Ru) 
