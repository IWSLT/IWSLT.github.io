...
* [ITV Studios](https://www.itvstudios.com/) is part of ITV Plc, which includes the UK's largest commercial broadcaster. They create and produce a broad range of programming (drama, entertainment, and factual) in 13 countries and distribute it globally, providing high-quality subtitles. We would like to thank ITV Studios for providing IWLST with samples of their video content for research and evaluation purposes, and would like to ask IWSLT participants not to use these videos and/or the accompanying subtitles for any commercial purposes or to make them publicly available on any other website.
