...
| speech-to-text-parallel | en | de, ar, zh, ja | [CoVoST](https://github.com/facebookresearch/covost) | v2 | |
...
| text-parallel | en | zh, de, ar, ja | [NewsCommentary](https://data.statmt.org/news-commentary/v18/training) | v18 | |
| text-parallel | en | ar | [GlobalVoices](https://object.pouta.csc.fi/OPUS-GlobalVoices/v2018q4/tmx/ar-en.tmx.gz) | v2018q4 | | 
| text-parallel | en | ar, zh, de, ja | [OpenSubtitles](https://opus.nlpl.eu/OpenSubtitles/corpus/version/OpenSubtitles) | v2018 | |
...
| text-parallel | en | ar, zh, de, ja | [Tatoeba]([https://opus.nlpl.eu/Tatoeba.php](https://opus.nlpl.eu/Tatoeba/corpus/version/Tatoeba)) | v2023-04-12 | |
...
The evaluation will be performed using the Meetween [SPEECHM Evaluation Server](https://speechm.cloud.cyfronet.pl/0000005), see Submission STEP 0 below. 
...
* Once logged in to the  [SPEECHM Evaluation Server](https://speechm.cloud.cyfronet.pl/0000005), the submission process requires participants to create one or more Models for each language pair they intend to participate in <!--for the Offline task--> (English-Arabic, English-Chinese, English-German, English-Japanese, **LanguageAgnostic**).
...
* The created Model(s) must be used to submit runs for each of the test sets released for the chosen language pair (i.e., 1 test set for Engish-Arabic, 5 test sets for English-Chinese and English-Japanese, 6 test sets for English-German, **X test sets for LanguageAgnostic**).
...
<!-- To create a new model, follow these steps: --> 
    ...
    1.3 Create a new model:
       Insert the Model Name using the standardized format:
         ...
         ${TEAM}_IWSLT26_Offline_${LANGUAGE_PAIR}_${CONDITION}_${SUBMISSION_TYPE}
          ...
          Where:
           ...
           Example Model Names:
             KIT_IWSLT26_Offline_en-de_constrained_primary  
             KIT_IWSLT26_Offline_en-de_constrained_contrastive 
