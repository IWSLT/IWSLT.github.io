...
Results are reported in the [findings paper](https://aclanthology.org/2022.iwslt-1.10/). We've also made available the [system logs](https://dl.fbaipublicfiles.com/simultaneous_translation/iwslt2022_simul-s2t_logs.tgz).
